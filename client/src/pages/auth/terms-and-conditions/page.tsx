          ...
          <Box className="flex flex-col">
            ...
            <Box className="flex flex-col gap-10">
              ...
              <Box>
                ...
                <Typography variant="body1">
                  You hereby indemnify to the fullest extent LexPay from and against any and all liabilities, costs,
                ...
                <Typography variant="body1">
                  LexPay is permitted to revise these Terms at any time as it sees fit.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  These Terms constitute the entire agreement between LexPay and you.
                </Typography>
                <br />
