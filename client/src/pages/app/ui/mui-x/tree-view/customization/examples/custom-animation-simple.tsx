...
export default function CustomAnimationSimple() {
  return (
    <Box className="min-w-72">
      ...
      >
        <CustomTreeItem itemId="grid" label="Data Grid">
          ...
          <CustomTreeItem itemId="grid-pro" label="@mui/x-data-grid" />
          <CustomTreeItem itemId="grid-premium" label="@mui/x-data-grid" />
        </CustomTreeItem>
        <CustomTreeItem itemId="pickers" label="Date and Time Pickers">
          ...
          <CustomTreeItem itemId="pickers-pro" label="@mui/x-date-pickers" />
        </CustomTreeItem>
