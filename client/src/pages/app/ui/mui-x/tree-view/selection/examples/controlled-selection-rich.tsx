...
const MUI_X_PRODUCTS: TreeViewBaseItem[] = [
  {
    ...
    children: [
      ...
      { id: "grid-pro", label: "@mui/x-data-grid" },
      { id: "grid-premium", label: "@mui/x-data-grid" },
    ],
  },
  {
    id: "pickers",
    ...
    children: [
      ...
      { id: "pickers-pro", label: "@mui/x-date-pickers" },
    ],
  },
  {
    id: "charts",
...
export default function ControlledSelectionRich() {
  ...
  const handleSelectClick = () => {
    setSelectedItems((oldSelected) => (oldSelected.length === 0 ? getAllItemItemIds() : []));
  };
