...
import { randomArrayItem, randomCreatedDate, randomId, randomTraderName } from "../../../../../../../utils/mockData";
...
export default function RowEditing() {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      getActions: ({ id }) => {
        ...
        return [
          <GridActionsCellItem
            key={"edit-" + rowModesModel[id]}
            icon={<NiPen size={"small"} />}
            label="Edit"
