...
const initialRows = [
  {
    ...
    labels: [{ id: crypto.randomUUID(), color: "text-accent-2-light/40" }],
  },
  {
    id: crypto.randomUUID(),
    iconBackground: "bg-accent-1-light/10",
        ...
        <Grid container spacing={5} className="mb-4 w-full">
          <Grid container spacing={2.5} className="w-full" size={12}>
            <Grid size={{ xs: 12, md: "grow" }}>
              <Typography variant="h1" component="h1" className="mb-0 flex flex-row items-center gap-1">
                <NiSquircle className="text-accent-2-light/50" variant="contained" size="large" />
                <Box>Meeting</Box>
              </Typography>
              <Breadcrumbs>
