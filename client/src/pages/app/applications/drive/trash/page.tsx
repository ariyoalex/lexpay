...
export default function Page() {
  ...
  const columns: GridColDef<(typeof rows)[number]>[] = [
    ...
    },
    {
      ...
      headerAlign: "right",
      getActions: () => [
        <GridActionsCellItem key={1} icon={<NiRefresh size="medium" />} label="Restore" showInMenu />,
        <GridActionsCellItem key={2} icon={<NiBinEmpty size="medium" />} label="Delete" showInMenu />,
      ],
    },
  ];
