...
const initialRows = [
  {
    ...
    name: "Quarterly_Townhall_Speaker_Panel.jpg",
    owner: "Laura Ellis",
    ownerAvatar: "/images/avatars/avatar-1.jpg",
    modifiedAt: dayjs().subtract(5, "hours").toDate(),
    labels: [
      { id: crypto.randomUUID(), color: "text-primary-light/40" },
      { id: crypto.randomUUID(), color: "text-secondary-light/40" },
    ],
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Brand_Identity_Style_Guide_Cover.png",
    owner: "Sofia Bennett",
    ownerAvatar: "/images/avatars/avatar-5.jpg",
    modifiedAt: dayjs().subtract(8, "hours").toDate(),
    labels: [
      { id: crypto.randomUUID(), color: "text-primary-light/40" },
      { id: crypto.randomUUID(), color: "text-secondary-light/40" },
    ],
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Employee_Recognition_Ceremony_2025.jpg",
    owner: "Sofia Bennett",
    ownerAvatar: "/images/avatars/avatar-5.jpg",
    modifiedAt: dayjs().subtract(10, "hours").toDate(),
    labels: [
      { id: crypto.randomUUID(), color: "text-primary-light/40" },
      { id: crypto.randomUUID(), color: "text-secondary-light/40" },
    ],
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Digital_Ad_Creative_Mobile_Version.png",
    owner: "Sofia Bennett",
    ownerAvatar: "/images/avatars/avatar-5.jpg",
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Boardroom_Strategy_Session_Konya.jpg",
    owner: "Sofia Bennett",
    ownerAvatar: "/images/avatars/avatar-5.jpg",
    modifiedAt: dayjs().subtract(2, "days").toDate(),
    labels: [
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Financial_Report_Charts_YTD.png",
    owner: "Sofia Bennett",
    ownerAvatar: "/images/avatars/avatar-5.jpg",
    modifiedAt: dayjs().subtract(2, "days").toDate(),
    labels: [
  ...
  },
  {
    ...
    modifiedAt: dayjs().subtract(5, "days").toDate(),
    starred: false,
    size: 360000,
    location: { path: "/applications/drive/folder", label: "Images" },
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "HR_Policy_Handbook_Cover_Design.jpg",
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Startup_Incubator_Pitch_Winner.jpg",
    owner: "Daniel Fontaine",
    ownerAvatar: "/images/avatars/avatar-4.jpg",
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "UX_Workshop_Sketches_Whiteboard.png",
    owner: "Daniel Fontaine",
    ownerAvatar: "/images/avatars/avatar-4.jpg",
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Client_Testimonial_Quote_Visual.jpg",
    owner: "Lucas Wright",
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Office_Renovation_Before_After.jpg",
    owner: "Lucas Wright",
    ownerAvatar: "/images/avatars/avatar-2.jpg",
    modifiedAt: dayjs().subtract(6, "days").toDate(),
    starred: false,
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Global_Team_Intro_Slide_Deck.png",
    owner: "Lucas Wright",
    ownerAvatar: "/images/avatars/avatar-2.jpg",
    modifiedAt: dayjs().subtract(6, "days").toDate(),
    starred: false,
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Legal_Contract_Signing_Ceremony.jpg",
    owner: "Lucas Wright",
    ownerAvatar: "/images/avatars/avatar-2.jpg",
    modifiedAt: dayjs().subtract(2, "days").toDate(),
    starred: false,
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Product_Feature_Explainer_Graphic.png",
    owner: "Lucas Wright",
    ownerAvatar: "/images/avatars/avatar-2.jpg",
    modifiedAt: dayjs().subtract(10, "days").toDate(),
    starred: false,
  ...
  },
  {
    ...
    iconColor: "text-accent-1",
    icon: "NiDocumentImage",
    name: "Annual_Gala_Event_Promo_Banner.jpg",
    owner: "Lucas Wright",
    ownerAvatar: "/images/avatars/avatar-2.jpg",
